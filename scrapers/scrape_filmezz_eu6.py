    ...
    if response.status_code == 200:
        ...
        for link in links:
            try:
                ...
                soup_links = BeautifulSoup(response.text, 'lxml')
                movie_links = soup_links.find(class_='content-box').find(class_='url-list').\
                ...
                print(e)
                if sys.exc_info() and len(sys.exc_info()) > 2:
                    print("on line: " + str(sys.exc_info()[2].tb_lineno))
                # print(e.message)
