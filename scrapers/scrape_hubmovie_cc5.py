...
OUTPUT_FILE = open('hubmovie_cc5.json', 'a+', encoding='utf-8')
...
try:
    with open('movies_crawled_hubmovie2.txt', 'r', encoding='utf-8') as f:
...
MOVIES_CRAWLED = open('movies_crawled_hubmovie2.txt', 'a+', encoding='utf-8')
...
if __name__ == "__main__":
    ...
    with open('hubmovie_cc5.json', 'rb+') as filehandle:
        filehandle.seek(-2, os.SEEK_END)
        filehandle.truncate()
    with open('hubmovie_cc5.json', 'a+') as filehandle:
        filehandle.write('\n]')
